...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
  ...
  if (empty(trim($_POST["password"]))) {
    ...
    $passwordErr = "Password should be atleast 8 characters long";
  } else {
  ...
  if (empty($usernameErr) && empty($passwordErr) && empty($confirmPasswordErr)) {
    ...
    $stmt = mysqli_prepare($conn, $sql);
    if ($stmt) {
      mysqli_stmt_bind_param($stmt, "ss", $usernameParam, $passwordParam);
      // Set these paramters
    ...
    <div class="container mt-4">
      ...
      <form action="" method="POST">
        ...
        <div class="form-group">
          ...
          <input name="confirmPassword" type="password" class="form-control" id="inputAddress" placeholder="Confirm Password">
